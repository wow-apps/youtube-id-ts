/**
 * Cross-platform SHA256/SHA512 hashing.
 * Uses Node.js crypto when available, falls back to pure JS implementation.
 */
...
// SHA-512 uses 64-bit integers, which we represent as pairs of 32-bit integers
